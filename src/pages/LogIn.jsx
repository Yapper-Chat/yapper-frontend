...
function LogIn() {
  return (
    <AuthLayout title="Log In">
        <div className="flex flex-col md:w-[90%] lg:w-[75%] gap-[40px] p-[20px]">
            {/* FORM TITLE */}
            ...
            <form action="" method="post" className="flex flex-col gap-[20px]">
                ...
                {/* LOG IN */}
                <button type="submit" data-toggle-password class="w-full bg-gradient-to-r from-[#ffd903] to-[#ffe54f] text-white p-3 rounded-lg transition-all hover:shadow-sm duration-500ms cursor-pointer">
                    Login
                </button>
            ...
            {/*  */}
            <p className="text-center">Don’t have and account? <span className="font-semibold cursor-pointer" href="">Sign up</span></p>
        </div>
